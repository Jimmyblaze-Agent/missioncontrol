...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona 5-7 noticias más relevantes para el nicho de Jeremy",
  ...
  },
  {
    ...
    steps: [
      ...
      "Evalúa si el trend es relevante para el canal de Jeremy",
  ...
  },
  {
    ...
    steps: [
      ...
      "Selecciona tema con mayor potencial de engagement para la audiencia de Jeremy",
      "Redacta post de LinkedIn en la voz de Jeremy (profesional-cercano, sin emojis ni hashtags)",
  ...
  },
  {
    ...
    description: "Digest curado de las newsletters del día. Consolida lo mejor de las suscripciones de Jeremy en un resumen accionable.",
  ...
  },
  {
    ...
    description: "Categoriza y resume los emails del día para que Jeremy empiece la jornada sin inbox anxiety.",
    schedule: "7:45h (cada día)",
    trigger: "cron",
    status: "active",
    steps: [
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Jeremy envía /cfo, /cmo, /cto, /legal, /growth, /coach o /producto",
      "GreenOx Digital carga el skill advisory-board/SKILL.md",
      "Lee el archivo de memoria del advisor correspondiente (memory/advisors/)",
      "Responde en la voz y personalidad del advisor con contexto de Jeremy",
  ...
  },
  {
    ...
    status: "active",
    steps: [
      "Comprueba si hay cambios en el workspace de GreenOx Digital",
  ...
  },
  {
    ...
    steps: [
      ...
      "Notifica a Jeremy por Telegram con el resumen de lo implementado",
    ],
  },
];
